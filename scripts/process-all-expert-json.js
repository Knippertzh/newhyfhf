// Script to process all expert JSON files from public/expertbackup to MongoDB
...
async function processAllExpertJson() {
  console.log('Starting processing of all expert JSON files...');
  ...
  try {
    ...
    console.log(`Found ${files.length} JSON files to process (excluding sample-experts.json)`);
...
processAllExpertJson().catch(console.error);