// Script to upload expert JSON files from public/expertbackup to MongoDB
...
async function uploadExpertsFromBackup() {
  console.log('Starting expert upload from backup files...');
...
uploadExpertsFromBackup().catch(console.error);